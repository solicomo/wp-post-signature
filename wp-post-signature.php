...
function RegisterPluginLinks($links, $file) {
	...
	$options_page = trailingslashit(dirname($base)) . "wp-post-signature-page.php";
	if ($file ==$base) {
		$links[] = '<a href="options-general.php?page=' . $options_page .'">' . __('Settings','wp-post-signature') . '</a>';
